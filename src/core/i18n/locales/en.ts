...
export const enMessages = {
  ...
  components: {
    ...
    embeddingDownload: {
      ...
      description: "Dynamic Memory requires downloading a local embedding model (~260 MB) to function.",
    ...
    embeddingUpgrade: {
      ...
      v1Message: "You're using v1 with 512 tokens. Upgrade to v3 for better memory quality and long-context support.",
      v2Message: "You're using legacy v2. Upgrade to v3 for better memory quality with the latest embedding model.",
  ...
  colorCustomization: {
    tokens: {
      ...
      accent: "Accent",
      accentDesc: "Primary interactive elements",
    },
    presets: {

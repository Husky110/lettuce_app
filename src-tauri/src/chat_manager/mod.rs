...
pub use commands::{
    ...
    __cmd__chat_continue, __cmd__chat_generate_user_reply, __cmd__chat_regenerate,
    ...
    chat_add_message_attachment, chat_completion, chat_continue, chat_generate_user_reply,

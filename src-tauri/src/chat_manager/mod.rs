...
pub use commands::{
    ...
    __cmd__reset_avatar_generation_template, __cmd__reset_design_reference_template,
    ...
    reset_avatar_generation_template, reset_design_reference_template,
    ...
    reset_local_roleplay_template, reset_scene_generation_template,
